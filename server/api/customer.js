...
router.get(
  ...
  async function (req, res) {
    try {
      const _id = req.params.id;
      console.log("ID nhận được =", _id);

      const cust = await CustomerDAO.selectByID(_id);
      console.log("Customer lấy được =", cust);

      if (cust) {
        console.log("Đang gửi mail tới:", cust.email);

        const send = await EmailUtil.send(cust.email, cust._id, cust.token);
        console.log("Kết quả gửi mail =", send);
      ...
      console.error("LỖI SEND MAIL:", err);
